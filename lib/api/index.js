...
export const subscriptions = {
  // {plan, access:{has_access,is_trial,trial_ends_at,paid_until,days_remaining},
  //  plans:[{id,label,price_usd,days}], payments_enabled}
  status: () => get('/subscriptions/status'),

  // Returns a NOWPayments hosted invoice URL. There is no saved payment
  // method and nothing renews on its own — each period is a fresh invoice.
